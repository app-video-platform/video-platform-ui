...
export const docRoutes: DocRoute[] = [
  ...
  { path: 'auth/signup', meta: { access: 'public' }, id: 'signup' },
  { path: 'auth/login', meta: { access: 'public' }, id: 'login' },
  { path: 'auth/verify-email', meta: { access: 'public' }, id: 'verify-email' },
  { path: 'auth/email-sent', meta: { access: 'public' }, id: 'email-sent' },
