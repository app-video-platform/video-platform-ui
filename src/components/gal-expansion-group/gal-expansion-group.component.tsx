...
import './gal-expansion-group.styles.scss';
...
interface GalExpansionGroupProps {
...
const GalExpansionGroup: React.FC<GalExpansionGroupProps> = ({
  mode = 'none',
  value,
  defaultValue = null,
  onValueChange,
...
export default GalExpansionGroup;
