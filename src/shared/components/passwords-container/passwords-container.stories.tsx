...
import PasswordsContainer from './passwords-container.component';

const meta: Meta<typeof PasswordsContainer> = {
  title: 'Components/PasswordsContainer',
  component: PasswordsContainer,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
...
export default meta;
type Story = StoryObj<typeof PasswordsContainer>;
