...
import type { LocationSearchPlace } from './location-search.component';
...
export const Default: Story = {
  render: () => {
    const [selected, setSelected] = useState<LocationSearchPlace | null>(null);

    return (
      <div style={{ width: '400px' }}>
        <OSMLocationSearch
          onSelect={(place: React.SetStateAction<LocationSearchPlace | null>) =>
            setSelected(place)
          }
        />
        {selected && (
