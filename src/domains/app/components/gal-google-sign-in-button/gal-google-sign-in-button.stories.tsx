...
import GalGoogleSignInButton from './gal-google-sign-in-button.component';

const meta: Meta<typeof GalGoogleSignInButton> = {
  title: 'Components/GalGoogleSignInButton',
  component: GalGoogleSignInButton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
...
export default meta;
type Story = StoryObj<typeof GalGoogleSignInButton>;
